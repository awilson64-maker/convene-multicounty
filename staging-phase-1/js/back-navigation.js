(() => {
  ...
  function loadAppLoader() {
    if (document.querySelector('script[data-convene-app-loader]') || window.__conveneAppLoaderLoaded) return;
    const script = document.createElement('script');
    script.src = 'js/app-loader.js';
    script.defer = true;
    script.setAttribute('data-convene-app-loader', 'true');
